...
- :support:`-` As Python 3.6 is EOL soon, we've dropped support. We have also dropped support for Python 3.7 due to a dependency of ours, so pretalx supports Python versions 3.8+.
