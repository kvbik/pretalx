...
setup(
    ...
    install_requires=[
        ...
        "django-filter==22.1",  # https://github.com/carltongibson/django-filter/blob/main/CHANGES.rst
        "django-formset-js-improved==0.5.0.3",  # no changelog, https://github.com/pretix/django-formset-js
        "django-formtools>=2.3,<2.5",
        ...
        "requests~=2.28.0",  # https://2.python-requests.org/en/master/community/updates/#release-and-version-history
        ...
        "whitenoise>=6.0,<6.3",  # http://whitenoise.evans.io/en/stable/changelog.html
